...
public final class UrlUtils {
	...
	/**
	 * eg 2013shiyan.yx.teacher.com.cn/demo/render
	 * 
	 * @param @param r
	 * @param @return 设定文件
	 * @return String 返回类型
	 * @throws
	 */
	public static String buildDomainRequestUrl(HttpServletRequest r) {
		return r.getServerName() + buildRequestUrlNoQuery(r);
	}

	public static String buildRequestUrlNoQuery(HttpServletRequest r) {
		return buildRequestUrl(r.getServletPath(), r.getRequestURI(),
				r.getContextPath(), r.getPathInfo(), null);
	}

	/**
	 * eg http://2013shiyan.yx.teacher.com.cn/demo/render
	 * 
	 * @param @param r
	 * @param @return 设定文件
	 * @return String 返回类型
	 * @throws
	 */
	public static String buildAbsoluteDomainRequestUrl(HttpServletRequest r) {
		return "http://" + r.getServerName() + buildRequestUrlNoQuery(r);
	}
