...
<div class="row">
    ...
    <div class="col-xs-12">
        ...
        <h3 class="header lighter">
            <form method="get" class="form-inline" action="${request.contextPath}/product/type/index">
                <div class="form-group">
                    <label>名称：</label>
                    <input type="text" name="typeName" value="${productType.typeName}"/>
                </div>
                         ...
                         <tr>
                             ...
                             <td>
                                 <div class="visible-md visible-lg hidden-md hidden-xs action-buttons">
                                     <a class="btn btn-sm btn-info" href="${request.contextPath}/product/type/edit?id=${item.id}">
                                         编辑
                                     </a>
                                     <a class="btn btn-sm  btn-danger btnConfirm" href="${request.contextPath}/product/type/del/${item.id}">
                                         删除
                                     </a>
                                 </div>
                             </td>
...
<script>
    function add() {
        location.href = "${request.contextPath}/product/type/edit";
    }
</script>
</@override>
